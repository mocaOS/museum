...
async function handleConfirm() {
  try {
    ...
    // fetch info from https://api.museumofcryptoart.com/users/0x4B191bF8b1046219b8b2c6951EF221575d8cf4E9 and if it returns 404, then trow
