<template>
  ...
  >
    ...
    <canvas
      ref="canvasRef"
      class="
        pointer-events-none absolute top-[20%] left-2 origin-top-left scale-50
        pr-20 text-base invert
        sm:left-8
        dark:invert-0
      "
      :class="[
    ...
    <input
      ...
      type="text"
      class="
        relative z-50 size-full rounded-full border-none pr-20 pl-4 text-sm
        text-black
        focus:ring-0 focus:outline-none
        sm:pl-10 sm:text-base
        dark:text-white
      "
    ...
    <button
      ...
      type="submit"
      class="
        absolute top-1/2 right-2 z-50 flex size-8 -translate-y-1/2 items-center
        justify-center rounded-full bg-black transition duration-200
        disabled:bg-gray-100
        dark:bg-zinc-900 dark:disabled:bg-zinc-700
      "
    >
      <svg
    ...
    >
      ...
      >
        <p
          ...
          class="
            w-[calc(100%-2rem)] truncate pl-4 text-left text-sm font-normal
            text-neutral-500
            sm:pl-10 sm:text-base
            dark:text-zinc-500
          "
