...
app.configure([
  ...
  { key: 'apiUrl', type: 'text', label: 'Museum API', hint: 'MOCA API base URL the guide asks for answers', initial: "https://api.moca.qwellco.de" },
...
const BAKED_SUGGESTIONS = ["Who designed the room “Escher’s Artifact”?","What is cryptoart, and why does it matter?","Who is Yatreda ያጥሬዳ?"]
...
const SOUL_NAME = ""
const SOUL_REF = null
const API = str(props.apiUrl, "https://api.moca.qwellco.de").replace(/\/+$/, '')
  ...
  app.on('update', (dt) => {
    ...
    if (!greeted && distSq < (TALK_DIST + 3) * (TALK_DIST + 3)) {
      ...
      try {
        world.chat({
          from: NAME,
          body: 'Welcome to “' + EXHIBITION.name + '”! Hold E at me and I’ll tell you about it.',
        }, false)
      } catch (e) {
