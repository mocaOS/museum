...
app.configure([
  { key: 'guideName', type: 'text', label: 'Guide name', initial: "Zete" },
  { key: 'decc0', type: 'number', label: 'DeCC0 persona', hint: 'Art DeCC0 token id whose soul the guide adopts (default 4209 = Tsahafi, the scholar-curator)', min: 0, max: 10000, step: 1, initial: 133 },
...
const NAME = str(props.guideName, "Zete")
const DECC0 = numOr(props.decc0, 133)
