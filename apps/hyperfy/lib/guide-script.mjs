 ...
 * @param {string} [opts.guideName]    the guide's display name (default "Tsahafi")
 * @param {number} [opts.decc0Id]      Art DeCC0 token id whose persona the guide adopts (default 4209, Tsahafi)
